            ...
            <tbody>
                <c:forEach items="${os}" var="o">
                    <tr>
                        ...
                        <td align="center">￥<fmt:formatNumber type="number" value="${o.total}"
                                                              minFractionDigits="2"></fmt:formatNumber> </td>
                        <td align="center">${o.totalNumber}</td>
                        <td align="center">${o.user.name}</td>
                        <td align="center"><fmt:formatDate
                                value="${o.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/> </td>
                        <td align="center"><fmt:formatDate
                                value="${o.payDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        <td align="center"><fmt:formatDate
                                value="${o.deliveryDate}" pattern="yyyy-MM-dd HH-mm-ss"/> </td>
                        <td align="center"><fmt:formatDate
                                value="${o.confirmDate}" pattern="yyyy-MM-dd HH-mm-ss"/></td>
                        <td><button oid="${o.id}"
                                    class="orderPageCheckOrderItems btn btn-primary btn-xs">查询详情</button>
